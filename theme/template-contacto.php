 ...
 * Félix 11/08: sin intro, campo "Número del pedido" en vez de "Teléfono".
 */
get_header(); ?>
    ...
    <div class="bp-container bp-page-content">
        <div class="bp-contact-page">
            <div class="bp-contact-header">
                <h1 class="bp-page-title"><?php echo bp_form_titulo('contacto'); ?></h1>
            </div>
            <div class="bp-contact-body">
                ...
                <form id="bp-form-contacto" class="bp-form" method="post">
                    ...
                    <?php bp_form_field('text', 'numero_pedido', 'Número del pedido', false); ?>
                    <p class="bp-form-row">
